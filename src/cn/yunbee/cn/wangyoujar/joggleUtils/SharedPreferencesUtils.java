...
public class SharedPreferencesUtils {
	private static volatile SharedPreferencesUtils spMg = null;
	...
	public static SharedPreferencesUtils getInstance(Context context) {
		if(spMg == null) {
			synchronized (SharedPreferencesUtils.class) {
				if(spMg == null) {
					spMg = new SharedPreferencesUtils(context, null);
				}
			}
		}
		return spMg;
	...
	public static SharedPreferencesUtils getInstance(Context context, String filename) {
		if(spMg == null) {
			synchronized (SharedPreferencesUtils.class) {
				if(spMg == null) {
					spMg = new SharedPreferencesUtils(context, filename);
				}
			}
		}
		
		if(filename != null && !filename.equals(spMg.filename)) {
			spMg.filename = filename;
		}
		
		spMg.sp =  context.getSharedPreferences(filename, spMg.mode);
